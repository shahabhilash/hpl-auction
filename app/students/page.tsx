...
export default function Students() {
  const students = [
    { id: 1, name: "Rahul Sharma", roll: "2023CS01", house: "Tons Tigers", status: "Sold" },
    { id: 2, name: "Amit Patel", roll: "2023EE14", house: "Unassigned", status: "Available" },
    { id: 3, name: "Priya Singh", roll: "2024ME05", house: "Orsang Leopards", status: "Sold" },
  ];
